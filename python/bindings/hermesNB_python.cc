...
/* BINDTOOL_HEADER_FILE_HASH(f53e3d61a13e2c2404ff8df583749b8e)                     */
/***********************************************************************************/
...
void bind_hermesNB(py::module& m)
{
    ...
    py::class_<hermesNB, gr::block, gr::basic_block,
        ...
        .def("set_HardwareAGC",&hermesNB::set_HardwareAGC,       
            py::arg("AGC"),
        ...
        .def("set_LNAGain",&hermesNB::set_LNAGain,       
            py::arg("LNAG"),
        ...
        .def("set_OnboardPA",&hermesNB::set_OnboardPA,       
            py::arg("PA"),
        ...
        .def("set_Q5Switch",&hermesNB::set_Q5Switch,       
            py::arg("Q5"),
